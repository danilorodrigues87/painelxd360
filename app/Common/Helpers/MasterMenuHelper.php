		...
		return [
			...
			[
				...
				'items' => [
					...
					['id' => 'contratos', 'label' => 'Contratos', 'url' => '/master/contratos', 'icon' => 'fas fa-file-signature'],
					['id' => 'contrato_saas', 'label' => 'Modelo de contrato', 'url' => '/master/contrato-saas', 'icon' => 'fas fa-file-contract'],
